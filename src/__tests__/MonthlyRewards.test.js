...
describe('MonthlyRewards component', () => {
  it('renders headers and monthly reward rows', () => {
    const data = [
      { customerId: 'C001', name: 'Alice', month: 1, year: 2024, rewardPoints: 120 },
      { customerId: 'C002', name: 'Bob', month: 2, year: 2024, rewardPoints: 95 },
    ];

    render(<MonthlyRewards data={data} />);
